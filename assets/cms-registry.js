...
(function () {
  ...
  const clusters = {
    seo: {
      ...
      url: "/tools/seo-tools/",
      icon: "Search",
      description: "Meta tags, SERP previews, slugs, keyword checks and page publishing workflows.",
      cta: "Open SEO tools"
    },
    writing: {
      title: "Writing Tools",
      ...
      icon: "Text",
      description: "Counters, readability checks, cleanup utilities and copy workflows for clearer content.",
    ...
    dev: {
      ...
      icon: "Code",
      description: "JSON, URL, Base64 and HTML entity utilities built for fast debugging.",
    ...
    youtube: {
      ...
      icon: "Creator",
      description: "Title, thumbnail, description, hashtag, tag and tracking tools for creators.",
    ...
    tracking: {
      ...
      icon: "Chart",
      description: "Campaign links, UTM structure and measurable creator workflows.",
    ...
    web: {
      ...
      icon: "Shield",
      description: "HTTP checks, DNS lookup, IP subnet math, passwords, UUIDs, timestamps and robots.txt utilities.",
      cta: "Open web tools"
    },
    socialai: {
      ...
      icon: "Spark",
      description: "Hooks, captions, scripts, disclosures, repurposing and creator monetization utilities.",
  ...
  const tools = [
    ...
    ["meta-tag-optimizer", "Meta Tag Optimizer Pro Page", "seo", "/tools/meta-tag-optimizer/", "Dedicated meta optimizer entry for searchers who need title and description fixes.", ["Alias", "Canonical", "SEO entry"], ["meta-tags", "serp-preview", "slug-generator"], ["meta-tags-checklist", "meta-tags-length", "serp-preview"]],
    ...
    ["url-encoder-decoder", "URL Encoder Decoder", "dev", "/tools/url-encoder-decoder/", "Alternative URL encode/decode entry for users searching complete wording.", ["Alias", "Canonical", "Query repair"], ["url-encoder", "utm-builder", "base64"], ["url-encoding-basics", "query-string-best-practices", "url-encoding-explained"]],
    ...
    ["base64-encode-decode", "Base64 Encode Decode", "dev", "/tools/base64-encode-decode/", "Dedicated encode/decode page for payloads and token-like strings.", ["Alias", "Canonical", "Payloads"], ["base64", "json-formatter", "url-encoder"], ["base64-decode", "base64url-vs-base64", "debugging-tokens"]],
    ...
    ["html-entity-encoder", "HTML Entity Encoder / Decoder", "dev", "/tools/html-entity-encoder/", "Escape and unescape HTML entities without breaking markup.", ["Alias", "Canonical", "HTML safe"], ["entity-encoder", "url-encoder", "base64"], ["html-entities", "fix-broken-html", "encoding-vs-escaping"]],
    ["html-entity-encoder-decoder", "HTML Entity Encoder Decoder", "dev", "/tools/html-entity-encoder-decoder/", "Full encode/decode entry for escaped text and broken HTML snippets.", ["Alias", "Canonical", "Broken HTML"], ["entity-encoder", "html-entity-encoder", "url-encoder"], ["html-entities", "fix-broken-html", "encoding-vs-escaping"]],
  ...
  tools.push(...[
    ...
    ["content-gap-finder", "Content Gap Finder", "socialai", "/tools/content-gap-finder/", "Compare a topic against missing questions, angles, examples and internal links.", ["Content gaps", "SEO", "Angles"], ["keyword-density", "youtube-competitor-title-analyzer", "seo-content-checklist"], ["keyword-variations", "seo-content-checklist", "internal-linking-tools-sites"]],
  ...
  const guides = [
    ...
    ["serp-snippet-ctr", "SERP Snippets and CTR Testing", "seo", "/guides/serp-snippet-ctr/", "Plan useful snippet tests without clickbait.", "serp-preview"],
    ...
    ["url-encoding", "URL Encoding Explained", "dev", "/guides/url-encoding/", "Understand when and why query strings break.", "url-encoder"],
    ["url-encoding-basics", "URL Encoding Basics", "dev", "/guides/url-encoding-basics/", "Encode values safely for URLs and forms.", "url-encoder"],
    ...
    ["base64url-vs-base64", "Base64URL vs Base64", "dev", "/guides/base64url-vs-base64/", "Understand token-safe encoding differences.", "base64"],
    ["debugging-tokens", "Debugging Tokens", "dev", "/guides/debugging-tokens/", "Inspect token segments carefully and safely.", "base64"],
    ...
    ["fix-broken-html", "Fix Broken HTML", "dev", "/guides/fix-broken-html/", "Repair messy markup and unsafe characters.", "entity-encoder"],
