...
(function () {
  ...
  const clusters = {
    seo: {
      ...
      url: "/tools/seo-tools/",
      icon: "Search",
      description: "Prepare search-facing pages with clearer snippets, slugs, keyword balance and final publishing checks.",
      cta: "Open SEO tools"
    },
    writing: {
      title: "Writing Tools",
      ...
      icon: "Text",
      description: "Clean, measure and reshape drafts so text is easier to read, send and publish on any device.",
    ...
    dev: {
      ...
      icon: "Code",
      description: "Format, encode, decode and inspect payloads when a small technical issue blocks your next web task.",
    ...
    youtube: {
      ...
      icon: "Creator",
      description: "Prepare a YouTube upload from hook and thumbnail promise to description, hashtags, tags and tracking links.",
    ...
    tracking: {
      ...
      icon: "Chart",
      description: "Build trackable links with consistent campaign names before posts, ads, descriptions and newsletters go live.",
    ...
    web: {
      ...
      icon: "Shield",
      description: "Check domains, HTTP reachability, IP ranges, timestamps, passwords and crawl files directly in the browser.",
      cta: "Open web tools"
    },
    socialai: {
      ...
      icon: "Spark",
      description: "Turn creator ideas into platform-specific hooks, posts, disclosures and reusable content blocks.",
  ...
  const tools = [
    ...
    ["readability-analyzer", "Readability Analyzer", "writing", "/tools/readability-analyzer/", "Find hard-to-read sections and improve structure before publishing.", ["Score", "Clarity", "SEO copy"], ["word-counter", "keyword-density", "whitespace-cleaner"], ["readability-for-ranking", "readability-score", "readability-for-seo"]],
    ["text-case-converter", "Text Case Converter", "writing", "/tools/text-case-converter/", "Convert text between uppercase, lowercase, title case and sentence case.", ["Case fixes", "Clean text", "Ready to copy"], ["whitespace-cleaner", "slug-generator", "word-counter"], ["text-cleanup-workflow", "content-brief-template", "slug-best-practices"]],
    ...
    ["meta-tags", "Meta Tag Optimizer", "seo", "/tools/meta-tags/", "Write clearer titles and descriptions with length checks and search intent guidance.", ["Snippet", "Title length", "CTR"], ["serp-preview", "keyword-density", "slug-generator"], ["meta-tags-checklist", "how-to-write-meta-title-description", "serp-snippet-ctr"]],
    ...
    ["serp-preview", "SERP Snippet Preview", "seo", "/tools/serp-preview/", "Preview how a title, URL and description may appear before publishing.", ["Preview", "Snippet-ready", "Search intent"], ["meta-tags", "slug-generator", "keyword-density"], ["serp-preview", "serp-snippet-ctr", "meta-tags-length"]],
    ...
    ["youtube-title-generator", "YouTube Title Generator", "youtube", "/tools/youtube-title-generator/", "Generate YouTube title angles that balance hook, keyword, curiosity and clarity.", ["Hook", "Keyword", "Creator"], ["thumbnail-brief-generator", "youtube-description-generator", "utm-builder"], ["youtube-title-thumbnail-checklist", "youtube-description-template", "youtube-tracking-links"]],
    ...
    ["youtube-description-generator", "YouTube Description Generator", "youtube", "/tools/youtube-description-generator/", "Draft first lines, chapters, links, CTA blocks and hashtag placement.", ["First lines", "CTA", "Links"], ["youtube-title-generator", "youtube-hashtag-generator", "utm-builder"], ["youtube-description-template", "youtube-tracking-links", "youtube-hashtags-guide"]],
    ...
    ["password-generator", "Password Generator", "web", "/tools/password-generator/", "Generate strong browser-only passwords and passphrases that are easy to copy.", ["Crypto random", "Strong passwords", "No upload"], ["uuid-generator", "base64", "text-case-converter"], ["debugging-tokens", "encoding-vs-escaping", "text-cleanup-workflow"]],
    ["uuid-generator", "UUID Generator", "web", "/tools/uuid-generator/", "Generate one or many RFC 4122 UUID v4 values instantly in the browser.", ["UUID v4", "Bulk output", "Ready to copy"], ["password-generator", "timestamp-converter", "json-formatter"], ["debugging-tokens", "json-formatter-online", "base64-encode-decode"]],
  ...
  tools.push(...[
    ...
    ["youtube-chapter-generator", "YouTube Chapter Generator", "youtube", "/tools/youtube-chapter-generator/", "Turn a rough video outline into clean YouTube chapters and timestamps.", ["Chapters", "Description", "Ready to copy"], ["youtube-description-generator", "timestamp-converter", "video-script-outline-generator"], ["youtube-description-template", "youtube-tracking-links", "creator-content-calendar"]],
    ...
    ["tiktok-trend-brief-builder", "TikTok Trend Brief Builder", "socialai", "/tools/tiktok-trend-brief-builder/", "Turn a trend observation into a usable content brief with angle, format and CTA.", ["Trend brief", "Angles", "CTA"], ["tiktok-hook-generator", "video-script-outline-generator", "social-cta-generator"], ["content-brief-template", "creator-content-calendar", "keyword-variations"]],
    ...
    ["linkedin-post-formatter", "LinkedIn Post Formatter", "socialai", "/tools/linkedin-post-formatter/", "Format LinkedIn posts with a hook, spacing, bullets, CTA and mobile-friendly structure.", ["LinkedIn", "Formatting", "B2B"], ["carousel-outline-generator", "newsletter-subject-generator", "social-cta-generator"], ["readability-for-seo", "content-brief-template", "text-cleanup-workflow"]],
    ...
    ["media-kit-generator", "Media Kit Generator", "socialai", "/tools/media-kit-generator/", "Draft a creator media kit summary with niche, audience, metrics and offer sections.", ["Media kit", "Brand deals", "Profile"], ["sponsorship-rate-calculator", "instagram-bio-optimizer", "newsletter-subject-generator"], ["creator-content-calendar", "content-brief-template", "utm-best-practices"]],
    ...
    ["content-gap-finder", "Content Gap Finder", "socialai", "/tools/content-gap-finder/", "Find missing questions, angles, examples and internal links for a topic.", ["Content gaps", "SEO", "Angles"], ["keyword-density", "youtube-competitor-title-analyzer", "meta-tags"], ["keyword-variations", "seo-content-checklist", "internal-linking-tools-sites"]],
  ...
  /** @type {CmsGuide[]} */
  const guides = [
    ["seo-content-checklist", "SEO Content Checklist", "seo", "/guides/seo-content-checklist/", "Audit intent, structure, links and search-result readiness before publishing.", "meta-tags"],
    ...
    ["serp-snippet-ctr", "SERP Snippets and CTR Testing", "seo", "/guides/serp-snippet-ctr/", "Plan snippet tests that improve click clarity without drifting into clickbait or mismatched page promises.", "serp-preview"],
    ...
    ["readability-for-seo", "Readability for SEO", "writing", "/guides/readability-for-seo/", "Make pages easier to scan without weakening the message.", "readability-analyzer"],
    ...
    ["content-brief-template", "Content Brief Template", "writing", "/guides/content-brief-template/", "Turn search intent into a practical page outline.", "word-counter"],
    ...
    ["url-encoding-basics", "URL Encoding Basics", "dev", "/guides/url-encoding-basics/", "Encode pasted values safely for URLs, forms and tracking links before they break in use.", "url-encoder"],
    ...
    ["youtube-title-thumbnail-checklist", "YouTube Title and Thumbnail Checklist", "youtube", "/guides/youtube-title-thumbnail-checklist/", "Plan the title and thumbnail around the same reason to click.", "youtube-title-generator"],
    ["youtube-description-template", "YouTube Description Template", "youtube", "/guides/youtube-description-template/", "Write descriptions that support search, viewers and the next step.", "youtube-description-generator"],
